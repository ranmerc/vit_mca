...
COLUMN ADDRESS HEADING 'STUDENT|ADDRESS' FORMAT A50
...
COLUMN DESCRIPTION HEADING 'COURSE|DESCRIPTION' FORMAT A40
...
WHERE
    ...
    AND ENROLL.ENROLL_TIME = to_Date('17-NOV-2017','DD-MM-YYYY')
...
FROM
    ...
    DEPARTMENT
WHERE
    PROFESSOR.PROF_ID = DEPARTMENT.PROF_ID;
