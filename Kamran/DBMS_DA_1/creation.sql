...
CREATE TABLE ENROLL(
    ...
    CONSTRAINT GRADE_IN CHECK (GRADE IN ('S', 'A', 'B', 'C', 'D', 'C', 'F'))
);
...
CREATE TABLE PROFESSOR_DEPARTMENT(
    ...
    CONSTRAINT PROFESSOR_DEPARTMENT_DEPT_ID_FK FOREIGN KEY(PROF_ID) REFERENCES DEPARTMENT(DEPT_ID) ON DELETE CASCADE
);